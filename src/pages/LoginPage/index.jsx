...
export default function LoginPage() {
	...
	const handleSubmit = (e) => {
		e.preventDefault();
		login(email, password); //= Integracion con AuthContext(contexto) o API.
	};
			...
			<section className='login'>
				...
				<div className='formulario container d-flex justify-content-center align-items-center pt-5'>
					<form>
						...
						<button
							type='submit'
							className='btn btn-warning px-3 mx-2 my-1'
							onClick={handleSubmit}>
							Ingresar
						</button>
						<button
							type='submit'
							className='btn btn-dark text-warning px-3 mx-2 my-1'>
							Necesito Ayuda
						</button>
					</form>
				</div>
				<div className='wave'>
					<div className='custom-shape-divider-bottom-1643937408'>
						<svg
							data-name='Layer 1'
